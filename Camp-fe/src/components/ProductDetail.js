        ...
        <main className="product-detail-main w-100%">
            <div className="container">
                ...
                <div className="row product-main-info">
                    <div className="col">
                        <div className="main-pic">
                          <img src="https://images.pexels.com/photos/7055327/pexels-photo-7055327.jpeg?auto=compress&cs=tinysrgb&dpr=2&h=750&w=1260" alt=""></img>
                        </div>
                    </div>
                    <div className="col product-main-info d-flex flex-column">
                      ...
                      <div className="product-main-info-choise">
                        ...
                        <div>
                          <button className="btn-buy add-to-cart">
                              加入購物車
                          </button>
                        </div>
                        <div>
                ...
                <div className="product-intro">
                  <p>環保也能很時尚！OCEAN BOTTLE時尚環保水壺是每日喝水最佳夥伴，採用不鏽鋼及海洋再生塑料材質，減少使用一次性塑料瓶。搭配高質感啞光漆層及方便的手握提環，提升造型精緻度。一起為我們所生活的土地盡一份心力，降低地球資源的浪費。</p>
                </div>
                  ...
                  <div className="col d-flex justify-content-center align-items-center">
                    <div className="product-special">
                      ...
                      <p>
                        重量：230 g<br />
                        尺寸：500 ml<br />
                        材質：304不銹鋼、海洋再生塑料材質<br />
                        貨號：9319905295-30-00<br />
                      </p>
                    </div>
                  </div>
                  <div className="col product-pic-small">
